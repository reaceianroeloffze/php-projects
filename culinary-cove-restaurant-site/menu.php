...
?>
    ...
    <h2>Soups</h2>
    <ul>
        <li><strong>Roasted Root Vegetable-Soup</strong> - A comforting blend of seasonal root vegetables, slow-roasted and puréed into a creamy soup.</li>
    ...
    <ul>
        ...
        <li><strong>Honey Lavender Pana-Cota</strong> - A creamy Italian dessert infused with organic lavender and sweetened with local honey.</li>
    </ul>
